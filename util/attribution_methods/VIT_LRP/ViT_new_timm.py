# https://github.com/hila-chefer/RobustViT/blob/master/ViT/ViT_new.py
...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.,
        ...
        self.input = None
        self.input_plus_attn = None
        self.mlp_val = None

    def get_input(self):
        return self.input
    
    def get_input_plus_attn(self):
        return self.input_plus_attn

    def get_mlp_val(self):
        return self.mlp_val
    
    def save_input(self, input):
        self.input = input
    
    def save_input_plus_attn(self, input_plus_attn):
        self.input_plus_attn = input_plus_attn
    
    def save_mlp_val(self, mlp_val):
